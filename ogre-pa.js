...
var BOARD_HEIGHT, BOARD_IMAGE, BOARD_WIDTH, CRATERS, HEX_COLS, HEX_HEIGHT, HEX_OFFSET_X, HEX_OFFSET_Y, HEX_ROWS, HEX_WIDTH, IMAGE_URL, PIECE_IMAGES, RUBBLE, board, buildEdges, buildHexes, buildPieceImages, directionsEven, directionsOdd, getHexName, main, path, utils;
...
buildEdges = function() {
  var cCol, cHex, cName, cRow, crater, dirName, dirOffset, directions, edge, hex, hex1, hex2, name, odd, rubble, _i, _j, _k, _len, _len1, _len2, _ref, _ref1;
  _ref = board.hexes;
  for (name in _ref) {
    hex = _ref[name];
    hex.edges = {};
...
},{"./utils":9,"path":2}],8:[function(require,module,exports){
// Generated by CoffeeScript 1.6.3
...
},{"./board":7,"./utils":9,"backbone":1,"d3":5,"underscore":6}],9:[function(require,module,exports){
// Generated by CoffeeScript 1.6.3
var utils;
