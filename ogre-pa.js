...
var BOARD_HEIGHT, BOARD_IMAGE, BOARD_WIDTH, CRATERS, HEX_COLS, HEX_HEIGHT, HEX_OFFSET_X, HEX_OFFSET_Y, HEX_ROWS, HEX_WIDTH, IMAGE_URL, PIECE_HEIGHT, PIECE_IMAGES, PIECE_WIDTH, RUBBLE, board, buildEdges, buildHexes, buildPieceImages, directionsEven, directionsOdd, getHexName, main, path, utils;
...
CRATERS = ["0108", "0209", "0304", "0313", "0506", "0608", "0611", "0712", "0908", "0914", "1004", "1304", "1310", "1403", "1406", "1413", "1508"];

RUBBLE = [["0103", "0203"], ["0104", "0203"], ["0207", "0308"], ["0210", "0311"], ["0211", "0312"], ["0212", "0312"], ["0212", "0313"], ["0213", "0313"], ["0305", "0405"], ["0307", "0308"], ["0309", "0409"], ["0310", "0410"], ["0311", "0312"], ["0312", "0411"], ["0316", "0317"], ["0316", "0416"], ["0404", "0505"], ["0404", "0405"], ["0408", "0509"], ["0503", "0602"], ["0514", "0614"], ["0515", "0614"], ["0602", "0603"], ["0603", "0703"], ["0607", "0707"], ["0607", "0708"], ["0613", "0614"], ["0708", "0709"], ["0714", "0813"], ["0714", "0814"], ["0716", "0816"], ["0801", "0902"], ["0808", "0909"], ["0812", "0912"], ["0812", "0913"], ["0815", "0816"], ["0816", "0916"], ["0904", "1003"], ["0904", "0905"], ["0905", "1005"], ["0905", "0906"], ["0907", "1007"], ["0911", "1010"], ["0916", "0917"], ["1008", "1108"], ["1012", "1112"], ["1012", "1113"], ["1012", "1013"], ["1015", "1116"], ["1107", "1207"], ["1108", "1207"], ["1108", "1208"], ["1108", "1109"], ["1112", "1113"], ["1112", "1212"], ["1204", "1205"], ["1205", "1305"], ["1206", "1207"], ["1316", "1317"], ["1316", "1416"], ["1408", "1409"], ["1415", "1416"]];
...
buildHexes = function() {
  var col, hexes, name, oddCol, row, x, xIncrement, xOffset, y, yIncrement, yOffset, yOffsetEven, yOffsetOdd, _i, _j;
  hexes = {};
  ...
  for (col = _i = 1; 1 <= HEX_COLS ? _i <= HEX_COLS : _i >= HEX_COLS; col = 1 <= HEX_COLS ? ++_i : --_i) {
    oddCol = !!(col % 2);
    yOffset = oddCol ? yOffsetOdd : yOffsetEven;
...
buildEdges = function(hexes) {
  var cCol, cHex, cName, cRow, crater, dirName, dirOffset, directions, edge, hex, hex1, hex2, name, odd, rubble, _i, _j, _len, _len1, _ref;
  for (name in hexes) {
    hex = hexes[name];
    hex.edges = {};
    odd = !!(hex.col % 2);
    directions = odd ? directionsOdd : directionsEven;
  ...
  for (_j = 0, _len1 = RUBBLE.length; _j < _len1; _j++) {
    rubble = RUBBLE[_j];
    hex1 = hexes[rubble[0]];
    hex2 = hexes[rubble[1]];
    if (!hex1) {
...
},{"./utils":11,"path":2}],8:[function(require,module,exports){
// Generated by CoffeeScript 1.6.3
var backbone, board, d3, utils, _;
...
},{"./board":7,"./ui":10,"./utils":11,"backbone":1,"d3":5,"underscore":6}],9:[function(require,module,exports){
// Generated by CoffeeScript 1.6.3
var NS_SVG, NS_XLINK, svg;
...
svg.createElement = function(name) {
  return document.createElementNS(NS_SVG, name);
  return element;
};

svg.createImageElement = function(url) {
  var image;
...
// Generated by CoffeeScript 1.6.3
var board, buildPiece, drawDots, drawEdges, drawLabels, main, svg, ui;
...
main = function() {
  ...
  return buildPiece(board.pieceImages.b.ogre_mk5, board.hexes["1003"]);
};

buildPiece = function(url, hex) {
  var board$, group$, image$;
  board$ = $("#board");
...
drawEdges = function() {
  var board$, cls, dir, edge, id, line$, srcHex, _ref, _ref1;
  board$ = $("#board");
  _ref = board.hexes;
  for (id in _ref) {
    srcHex = _ref[id];
...
},{"./board":7,"./svg":9}],11:[function(require,module,exports){
// Generated by CoffeeScript 1.6.3
var utils;
